...
function mapProduct(item: any): Product {
    return {
        ...
        unit: item.unit || 'unit',
        minOrder: item.minOrder ?? item.moq ?? 10,
        ...
        unitsPerPallet: item.unitsPerPallet ?? undefined,
        palletsPerShipment: item.palletsPerShipment ?? undefined,
        readyForDispatch: item.readyForDispatch ?? false,
